...
public class UserController {
    ...
    {
    	Integer contactId = (Integer) session.getAttribute("userId");
    	if( contactId!=null)
    	{
    	...
    	else
    	{
    		...
    		{
    			return "Account Logout,Login Again...!";
    		}
    	}
    }
    ...
    ///Existing mob number check
    @RequestMapping(value = "/mobcheck_avail")
    @ResponseBody
    public String checkmobAvailability(@RequestParam String phone) 
    {
    	
        if(userService.isUsernameExist(phone)){
            return "This phone number is already taken !";
        }else{
            return "Yes! You can take it";
        }
    	}
