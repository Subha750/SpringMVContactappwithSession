...
<html>
    <head>
        ...
        <!-- Mobile number check avaliblity -->
        <script>
            $(document).ready(function (){
                $("#mob_check_avail").click(function(){
                    $.ajax({
                        url : 'mobcheck_avail',
                        data : { phone: $("#mob_number").val()} ,
                        success : function(data){
                            $("#mob_res_div").html(data);
                        }
                    });
                });
            });
                    ...
                    <f:form action="${url_reg}" modelAttribute="command">
                        <table border="1">
                            ...
                            <tr>
                               ...
                               <td><f:input id="mob_number" path="user.phone" placeholder="Phone Number"/> 
                                    <button type="button" id="mob_check_avail">Check Availability</button>               
                                    <div id="mob_res_div" class="error"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
                            ...
                            <tr>
                                <td>Username</td>
                                <td><f:input id="id_username" path="user.loginName" placeholder="Username" /> 
